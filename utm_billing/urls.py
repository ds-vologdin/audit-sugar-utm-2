...
from utm_billing.views import PayStatisticView, BlockUsersMonth, PayMonthStatisticView

urlpatterns = [
    path('pay/', PayStatisticView.as_view(), name='pay'),
    path('pay/<int:year>/', PayStatisticView.as_view(), name='pay_year'),
    path('pay/<int:year>/<int:month>/', PayMonthStatisticView.as_view(), name='pay_month'),
